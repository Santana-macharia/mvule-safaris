...
//CONNECT TO DATABASE
   ...
   //query the database
	$resultset= $mysqli->query("SELECT * FROM degreeportalcoarseid WHERE COARSENAME LIKE '%$search%' ");

	if($resultset->num_rows > 0){
          while($rows = $resultset->fetch_assoc() )
          {
          	 $COARSENAME=$rows['COARSENAME'];
             $COARSE_DETAILS=$rows['COARSEDETAILS'];
             $CAREER_OPTIONS=$rows['CAREEROPTIONS'];



             $output .= "COURSE NAME: $COARSENAME<br><br  /><hr>COURSE DETAILS: $COARSE_DETAILS<br><br /><hr>CAREER OPTIONS: $CAREER_OPTIONS<br /><br /> ";
          }
...
<img src="StudyPortals-Logo.png" alt="Mountain View" style="width:300px;height:70px;">
 <h1><center><span style="color:white;font-weight:italic">COURSE INFORMATION CENTRE</span> </center> </h1>
