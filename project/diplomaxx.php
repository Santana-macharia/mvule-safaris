...
//query the database
$resultset= mysqli_query($mysqli,"SELECT diplomaid.COARSENAME AS COARSENAME,
	diplomauniversity.UNIVERSITY AS UNIVERSITY 
	FROM diplomaid,diplomauniversity
	WHERE diplomaid.COARSENAME='$search' AND diplomauniversity.COARDEID = diplomaid.COARDEID");

	while($rows= mysqli_fetch_assoc($resultset) )
	{
		$diplomaid=$rows['COARSENAME'];
		$diplomauniversity = $rows['UNIVERSITY'];

		$output .= "<p><center>COURSE: $diplomaid<br />UNIVERSITY: $diplomauniversity<center></p>";
	}
...
<img src="StudyPortals-Logo.png" alt="Mountain View" style="width:300px;height:70px;">
 <h1><center><span style="color:white;font-weight:italic">DIPLOMA PORTAL</span> </center> </h1>
