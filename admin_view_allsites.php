...
<style>
body {
    background-image: url("images/25.jpg"); background-size: 1370px 1000px; background-repeat: no-repeat;
}</style>
<style>
  #box
  {
  ...
  .form-control{
    ...
    width:300px;
      ...
      <a href="admin_all_sites.php" class="btn btn-primary btn-xl page-scroll" 
                    ...
                    <div class="form-horizontal" >
                      ...
                      <div class="control-group">
                        ...
                        <div class="form-actions">
                          <a class="btn" href="admin_all_sites.php"></a>
                       </div>
