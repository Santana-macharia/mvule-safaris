...
<style>
body {
    background-image: url("images/79.jpg"); background-size: 1370px 1000px; background-repeat: no-repeat;
}</style>
<style>
  #box
  {
  ...
  .form-control{
    ...
    width:300px;
      ...
      <a href="forts_admin.php" class="btn btn-primary btn-xl page-scroll" 
                style="background-color: rgba(20, 20, 20, 0.99);"
                         style="border-color: #49a42e;">Back to Forts and Monuments</a>
                    ...
                    <div class="form-horizontal" >
                      ...
                      <div class="control-group">
                        ...
                        <div class="form-actions">
                          <a class="btn" href="forts_admin.php"></a>
                       </div>
