...
<style>
 ...
 <div class="container">
                ...
                <div class="span10 offset1">
                    ...
                    <form class="form-horizontal" action="delete_sites.php" method="post">
                      <input type="hidden" name="id" value="<?php echo $id;?>"/>
                      <p class="alert alert-error">Are you sure to delete ?</p>
                      <div class="form-actions">
                          <button type="submit" class="btn btn-danger" href="sites.php">Yes</button>
                          <a class="btn btn-primary" href="sites.php">No</a>
                        </div>
                    </form>
                </div>
        </div> <!--/conatainer -->
