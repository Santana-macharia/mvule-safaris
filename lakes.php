...
$sql = 'SELECT * FROM sites WHERE site_type_id=6 ORDER BY Site_ID DESC';
...
echo '<td width=400>';
echo '<a class="btn btn-primary" href="view_lakes.php?id='.$row['Site_ID'].'">View</a>';
echo '</td>';
          echo '</tr>';
      }
