...
<h1>MVULE SAFARIS</h1>
   <h2>Forts and Monuments</h2>
<ul  class="nav navbar-nav">
<li><a href="home.php">HOME</a></li>
<li><a href="about.php">ABOUT</a></li>
<li><a href="googleapi.php">MAPS</a></li>
...
$sql = 'SELECT * FROM sites WHERE site_type_id=9 ORDER BY Site_ID DESC';
...
echo '<td width=400>';
echo '<a class="btn btn-primary" href="view_forts.php?id='.$row['Site_ID'].'">View</a>';
echo '</td>';
          echo '</tr>';
      }
