...
echo '<td width=400>';
echo '<a class="btn btn-primary" href="view_users.php?id='.$row['userid'].'">View</a>';
echo ' ';
echo '<a class="btn btn-success" href="edit_users.php?id='.$row['userid'].'">Edit</a>';
echo ' ';
echo '<a class="btn btn-danger" href="delete_users.php?id='.$row['userid'].'">Delete</a>';
echo '</td>';
          echo '</tr>';
      }
      Database::disconnect();
